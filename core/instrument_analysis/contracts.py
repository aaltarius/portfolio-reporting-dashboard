"""Contratti dati puri del motore InstrumentAnalysis. Nessuna dipendenza da
rete, cache su disco o Streamlit — solo dataclass/enum, per restare
testabile in isolamento da ogni adapter/servizio."""
