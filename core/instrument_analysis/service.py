...
def _benchmark_to_cache(benchmark: BenchmarkResolution) -> dict:
    return {
        ...
        "fallback_fetchable_series": benchmark.fallback_fetchable_series,
        "fallback_fetchable_label": benchmark.fallback_fetchable_label,
...
def _benchmark_from_cache(data: dict) -> BenchmarkResolution:
    return BenchmarkResolution(
        ...
        fallback_fetchable_series=data.get("fallback_fetchable_series", ""),
        fallback_fetchable_label=data.get("fallback_fetchable_label", ""),
