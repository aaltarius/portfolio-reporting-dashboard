# Changelog — archivio versioni precedenti

Voci da `CHANGELOG.md` per le versioni precedenti alla linea di sviluppo 5.0-pre (4.9.40 e a scendere fino a 4.5), spostate qui il 2026-09-06 per alleggerire il changelog principale. Testo originale, invariato.
