    ...
    with tab:
        ...
        with _settings_form:
            ...
            with st.container():
                    ...
                    locale_code = i18n2.selectbox("Locale", ["it-IT", "en-US"], index=0 if str(i18n_settings.get("locale", "it-IT")) == "it-IT" else 1)
                    i18n3, i18n4 = st.columns(2)
                    date_format_pref = i18n3.selectbox("Formato data", ["DD/MM/YYYY", "MM/DD/YYYY"], index=0 if str(i18n_settings.get("date_format", "DD/MM/YYYY")) == "DD/MM/YYYY" else 1)
                    number_format_pref = i18n4.selectbox("Formato numerico", ["it-IT", "en-US"], index=0 if str(i18n_settings.get("number_format", "it-IT")) == "it-IT" else 1)
            _section_line()
            with st.container():
                render_section_title(
                    "Avanzate",
