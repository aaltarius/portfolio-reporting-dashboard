...
CHARTS: dict[str, dict[str, Any]] = {
    ...
    'pianificazione_allocation': {'type': 'bar',
     'height': 400,
     'legend': 'bottom',
     'show_buttons': False,
     'margin_delta': {'t': 0, 'b': -20, 'l': 0, 'r': -20},
     ...
     'y_tickformat': '.0%',
     'y_nticks': 10,
     'title': '<b>Allocazione prima e dopo la simulazione</b>'},

    'pianificazione_scenarios': {'type': 'time',
     'height': 420,
     'legend': 'bottom',
     'show_buttons': False,
     'margin_delta': {'t': 0, 'b': -10, 'l': 0, 'r': -10},
     'y_tickformat': ',.0f',
     'y_nticks': 8,
     'title': '<b>Scenari ipotetici sul patrimonio simulato</b>'},

    # ------------------------------------------------------------------
    # DA VERIFICARE / LEGACY
    # ------------------------------------------------------------------

    'overview_patrimonio': {'type': 'time',
     'height': 400,
     'legend': 'bottom',
     'show_buttons': True,
     'default_button': '3M',
     ...
     'y_nticks': 10,
     'x_nticks': 15,
     'title': '<b>Patrimonio del portafoglio</b>'},
